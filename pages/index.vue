<template>
  <div class="home">
    ...
    <div class="container search">
      <!-- Lazy = will update when user enters/leave the input -->
...
export default {
  ...
  methods: {
    async getMovies() {
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=2a6ca40a8000ba340b5bedbdf5c33547')
    ...
    async searchedMovies() {
      const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=2a6ca40a8000ba340b5bedbdf5c33547&language=en-US&page=1&query=${this.searchInput}`)
      const result = await data
      result.data.results.forEach(movie => {
